...
public final class CC {
    ...
    /**
     * @apiNote Assign core colors!
     */
    public static final String PRIMARY = ChatColor.YELLOW.toString() + ChatColor.BOLD.toString();
    public static final String SECONDARY = ChatColor.WHITE.toString() + ChatColor.BOLD.toString();
